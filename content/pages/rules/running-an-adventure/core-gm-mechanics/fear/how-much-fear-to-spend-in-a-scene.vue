...
<h4 id="что-делать-со-всем-этим-страхом"><span class="marker" data-marker="chapter"></span>Что делать со всем этим Страхом?<a class="anchor" href="#что-делать-со-всем-этим-страхом" aria-label="Ссылка на раздел"></a></h4>
<p>Если вы вступаете в бой с большим запасом Страха (особенно больше 10), рассмотрите следующие подходы:</p>
<h6 id="ударить-первым"><span class="marker" data-marker="minor"></span>Ударить первым<a class="anchor" href="#ударить-первым" aria-label="Ссылка на раздел"></a></h6>
<p>Потратьте 1 Страх сразу же, чтобы прервать персонажей игроков и активировать противника, начиная бой.</p>
<h6 id="тратить-последовательно"><span class="marker" data-marker="minor"></span>Тратить последовательно<a class="anchor" href="#тратить-последовательно" aria-label="Ссылка на раздел"></a></h6>
...
<h6 id="начать-мощно"><span class="marker" data-marker="minor"></span>Начать мощно<a class="anchor" href="#начать-мощно" aria-label="Ссылка на раздел"></a></h6>
...
<h6 id="пустить-первую-кровь"><span class="marker" data-marker="minor"></span>Пустить первую кровь<a class="anchor" href="#пустить-первую-кровь" aria-label="Ссылка на раздел"></a></h6>
